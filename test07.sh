...
echo "-------------Test Escaped Delimeters in mulitple commands------------"
(
seq 5| slippy 's/. \/ / x \/ /g ; s_ \_ \_ abc _ \_ _    g ; s: a : \:\: : s?  \?  ?  \?  ?  g  '

) > "$output" 

(
seq 5| 2041 slippy 's/. \/ / x \/ /g ; s_ \_ \_ abc _ \_ _    g ; s: a : \:\: : s?  \?  ?  \?  ?  g  '
) > "$expected_output" 
